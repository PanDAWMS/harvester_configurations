...
HARVESTER_DIR=/ccs/home/psvirin/harvesters/summit-ml/harvester
#CONTAINER_DIR=${HARVESTER_DIR}/var/lib/containers
CONTAINER_DIR=/gpfs/alpine/csc343/world-shared/harvester/var/lib/containers-tmp
...
function main() {
  ...
  cat ${HARVESTER_DIR}/scripts/ANALY_ORNL_Summit_make_container.lsf.template | \

...
if [ "/global/cfs/cdirs/m2616/harvester/var/lib/harvester.db" -nt "/tmp/harvester.db" ] ; then
    echo "/global/cfs/cdirs/m2616/harvester/var/lib/harvester.db is new than /tmp/harvester.db"
    cp -fv /global/cfs/cdirs/m2616/harvester/var/lib/harvester.db /tmp/harvester.db
fi

...
if [ "/gpfs/alpine/hep113/world-shared/harvester/var/lib/harvester.db" -nt "/tmp/harvester.db" ] ; then
    echo "/gpfs/alpine/hep113/world-shared/harvester/var/lib/harvester.db is new than /tmp/harvester.db"
    cp -fv /gpfs/alpine/hep113/world-shared/harvester/var/lib/harvester.db /tmp/harvester.db
fi

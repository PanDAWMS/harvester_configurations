...
module load anaconda3/2019.10-py3.7

if [ -z ${CONDA_DEFAULT_ENV+x} ]; then
    source /hpcgpfs01/software/anaconda3/2019.10-py3.7/etc/profile.d/conda.sh
    conda activate /hpcgpfs01/work/benjamin/harvester-knl-py3
fi
...
export ATLAS_LOCAL_ROOT_BASE=/hpcgpfs01/work/benjamin/ALRB/ATLASLocalRootBase; 
...
export SINGULARITY_TMPDIR=/hpcgpfs01/work/benjamin/harvester/singularity/tmp
export SINGULARITY_CACHEDIR=/hpcgpfs01/work/benjamin/harvester/singularity/cache

...
if [ "/hpcgpfs01/work/benjamin/harvester-knl-py3/var/lib/harvester.db" -nt "/tmp/harvester.db" ] ; then
    echo "/hpcgpfs01/work/benjamin/harvester-knl-py3/var/lib/harvester.db is new than /tmp/harvester.db"
    cp -fv /hpcgpfs01/work/benjamin/harvester-knl-py3/var/lib/harvester.db /tmp/harvester.db
fi
